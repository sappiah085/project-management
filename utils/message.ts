const message = {
  decline: {
    ...
    message:
      "We are sorry to inform you that your application to enroll {{name}} has been denied. You can contact admission office on why this is so. You can re-apply if you think there were mistakes in the earlier application.",
  },
  accepted: {
