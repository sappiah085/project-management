...
const Home: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Head>
        <title>realmann school | kids our future</title>
      ...
      >
        ...
        <ItemParentComp
          ...
          subtitle={"  Providing an exceptional educational experience fo success"}
        >
          <Reason />
        </ItemParentComp>
        {/* newsletters */}
        <ItemParentComp
          ...
          subtitle={"Stay up-to-date with the latest news and events at our school"}
        >
