...
export default function Notification() {
  return (
    <div className="absolute drop-shadow-sm flex flex-col top-[120%] border-[1px] px-4  rounded-2xl right-4  gap-4 z-20 bg-white w-full max-w-md">
      <h1 className="font-bold pt-5 px-3 text-sm  lg:text-xl">Notifications</h1>
      ...
      <div className="flex px-5 text-sm lg:text-lg items-center justify-between pb-2">
